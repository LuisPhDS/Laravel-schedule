...
@section('content')
    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <form action="{{ route('editar_contato_subimit')}}" method="post" enctype="multipart/form-data">
                @csrf

                {{-- Id do contato --}}
                <input type="hidden" name="id_contato" value="{{ Crypt::encrypt($contato->id) }}">
                    ...
                    <div class="col-5 mt-5">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="contato_nome" id="contato_nome" class="form-control border-success" value="{{ old('contato_nome', $contato->nome) }}" placeholder="João José da Silva xavier">
                            </div>
                            @error('contato_nome')
                        ...
                        <div class="mb-5">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" name="contato_tel" id="contato_tel" class="form-control border-success" value="{{ old('contato_tel', $contato->telefone) }}" placeholder="(XX) X XXXX-XXXX">
                            </div>
                            @error('contato_tel')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="contato_email" id="contato_email" class="form-control border-success" value="{{ old('contato_email', $contato->email) }}" placeholder="XXX@XXXX.XXX">
                            </div>
                            @error('contato_email')
                            ...
                            <div class="dropzone-box">
                                ...
                                <div class="dropzone-area">
                                    ...
                                    <input 
                                        ...
                                        value="{{ old('contato_imagem', $contato->imagem) }}"
                                    >
